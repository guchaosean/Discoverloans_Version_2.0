...
if (isset($_FILES['upload_file'])&& $_FILES['upload_file']['error'] == UPLOAD_ERR_OK && is_uploaded_file($_FILES['upload_file']['tmp_name'])) {
    ...
    <div style="height: 50px;" class="bootstrap-wrapper">
        <div style="height: 50px;"><div id="sdNotifications" class="alert alert-success" style="padding: 10px; box-shadow: none; display: block;"><span class="glyphicon glyphicon-ok" style="margin-right: 5px;"></span><span>Form Imported Successfully. Form Name: <?php echo $formName ?></span></div></div>
    </div>
