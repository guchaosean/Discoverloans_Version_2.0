  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Pay slips Management</li>
        </ul>
       
	     <form action="functions/search/search_user_payslip.php" method="post" class="form-horizontal" style="width:80%" id="search_form" >
		       ...
		       <div class="form-actions">
                  <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-default" style="color:#3980bf"    >Download Payslips</button>
                 </div>
               </div> 
