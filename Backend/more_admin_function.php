...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>More Admin Function</title>
...
function sendupdaterequest(){
	   ...
	   var url = "functions/update_onlinequote_table/update_quote_table.php"; // the script where you handle the form input.
...
<script type='text/javascript'>
function analyseGeoDate(){
	
	   var url = "functions/update_onlinequote_table/analyseGeoData.php "; // the script where you handle the form input.
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">More Admin Function</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="index.php">Home</a> <span class="divider">/</span></li>
            <li class="active">More Admin Function</li>
        </ul>
        <p>Update Online Quote to Database</p>
		<hr>
		<button type="button" onclick="javascript:sendupdaterequest()">Update</button>
        <p>Analyse Geo According to Ip Address</p>
		<hr>
		<button type="button" onclick="javascript:analyseGeoDate()">Analysing</button>
    </div>
